package org.panzhi.blog.web.servlet.dispatcher;
 ...
 */
@WebServlet(name ="webDispatcherServlet",urlPatterns = "/service/*",loadOnStartup = 1,initParams = {@WebInitParam(name="contextConfigLocation", value="sso-mvc.xml"),@WebInitParam(name="serviceLocation", value="service")})
	...
	private void doDispatch(HttpServletRequest request, HttpServletResponse response) throws IOException{
		try {
			...
			if(handle == null){
				...
				response.getWriter().append(BuildResponseMsg.buildFailMsgNoData(CommonErrorMsg.SRC_ERROR));
				return;
			}
			//获取参数列表
